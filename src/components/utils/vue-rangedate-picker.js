! function (t, e) {
  ...
  return function (t) {
    ...
    e.a = {
      ...
      created: function () {
        this.dateRange = this.initRange || null, this.isCompact && (this.isOpen = !0), 11 === this.activeMonthStart && (this.activeYearEnd = this.activeYearStart + 1)
      },
      watch: {
      ...
      methods: {
        ...
        getNewDateRange: function (t, e) {
          var n = {},
            a = "start";
          this.isFirstChoice ? n.end = null : a = "end";
          var r = new Date(this.activeYearStart, e, t);
          return !this.isFirstChoice && r < this.dateRange.start ? (this.isFirstChoice = !1, {
            start: r
          }) : (this.isFirstChoice = !this.isFirstChoice, n[a] = r, n)
        },
        selectFirstItem: function (t, e) {
          var n = this.getDayIndexInMonth(t, e, this.startMonthDay) + 1;
          this.dateRange = r()({}, this.dateRange, this.getNewDateRange(n, this.activeMonthStart)), this.dateRange.start && this.dateRange.end && (this.presetActive = "", this.isCompact && (this.showMonth = !1))
        },
        selectSecondItem: function (t, e) {
          var n = this.getDayIndexInMonth(t, e, this.startNextMonthDay) + 1;
          this.dateRange = r()({}, this.dateRange, this.getNewDateRange(n, this.startNextActiveMonth)), this.dateRange.start && this.dateRange.end && (this.presetActive = "")
        },
    ...
    var a = function () {
        ...
        return n("div", {
          ...
          return n("ul", {
            ...
            return n("li", {
              key: a,
              class: [(r = {}, r[t.s.daysSelected] = t.isDateSelected(e, a, "first", t.startMonthDay, t.endMonthDate), r[t.s.daysInRange] = t.isDateInRange(e, a, "first", t.startMonthDay, t.endMonthDate), r)],
              domProps: {
          ...
          return n("ul", {
            ...
            return n("li", {
              key: a,
              class: [(r = {}, r[t.s.daysSelected] = t.isDateSelected(e, a, "second", t.startNextMonthDay, t.endNextMonthDate), r[t.s.daysInRange] = t.isDateInRange(e, a, "second", t.startNextMonthDay, t.endNextMonthDate), r)],
              domProps: {
